            ...
            <div className="content-padding">
                <div className="about-main-container">
                    ...
                    <article>
                        <h1>Hello friend,</h1>
                        <br />
                        <p>welcome to my place! You may already know my name but i also known as Moku Ken, my 2nd perosnality that i created, im 20 years old taking 4 years of computer science in college and i'm currently focusing on my self-improvement and improving my programming skills.</p>
                        <br />
